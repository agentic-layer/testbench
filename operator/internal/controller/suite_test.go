...
var _ = BeforeSuite(func() {
	...
	By("creating the testkube namespace")
	tkNs := &corev1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "testkube"}}
	Expect(k8sClient.Create(context.Background(), tkNs)).To(Succeed())
