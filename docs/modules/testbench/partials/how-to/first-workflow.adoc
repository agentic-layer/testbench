...
* Learn about the internal data flow and evaluation architecture in xref:testbench:building-blocks/index.adoc[Building Block View]
* Explore cross-cutting concerns like tracing and observability in xref:testbench:crosscutting/index.adoc[Cross-cutting Concepts]
